...
export default function InventoryDashboard() {
  ...
  // --- CORE TRANSACTION LOGIC (PHASE 2) ---
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              <thead className="bg-slate-50 border-b border-slate-200">
                <tr>
                  <th className="p-5 text-sm font-semibold text-slate-600 uppercase tracking-wider">Product Info</th>
                  <th className="p-5 text-sm font-semibold text-slate-600 uppercase tracking-wider">Stock Level</th>
                  <th className="p-5 text-sm font-semibold text-slate-600 uppercase tracking-wider">Price</th>
                  <th className="p-5 text-sm font-semibold text-slate-600 uppercase tracking-wider">Status</th>
                  <th className="p-5 text-sm font-semibold text-slate-600 uppercase tracking-wider text-right">Inventory Actions</th>
                </tr>
              </thead>
                ...
                {filteredProducts.map((product) => (
                  <tr key={product.id} className="hover:bg-slate-50/80 transition-colors group">
                    <td className="p-5">
                      ...
                      <div className="text-xs text-slate-400 font-mono tracking-tighter">{product.sku}</div>
                    </td>
                    <td className="p-5">
