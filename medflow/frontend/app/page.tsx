          ...
          {isSuccess ? (
            <div className="text-center py-6 animate-in zoom-in duration-300">
              ...
              <button 
                ...
                className="w-full flex items-center justify-center gap-2 bg-sky-50 text-sky-600 py-3 rounded-xl font-bold text-sm hover:bg-sky-100 transition"
              >
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md z-[100] flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-md rounded-3xl p-8 shadow-2xl animate-in fade-in zoom-in duration-200">
            <div className="text-center">
              ...
              <button onClick={() => setIsModalOpen(false)} className="mt-8 text-slate-400 text-xs font-bold uppercase">Cancel</button>
            </div>
          </div>
        </div>
      )}
